...
#ifndef IMRESAMPLEMEX_HPP_
#define IMRESAMPLEMEX_HPP_
...
//cv::Mat pdGradient( std::string type, cv::Mat inputImage);
//cv::Mat* pdGradient( std::string type, cv::Mat inputImage, int channel, int full);

...
% myMat = [1 2 3 4 5];
% save('simpleMat.mat','myMat')
addpath(genpath('../../toolbox'))
addpath('../../code3.2.1')

dirTestImage = '../../../TestImages/I00000.png';
%% I have uncommented this section as it requires the INRIA data set. 
% %% extract training and testing images and ground truth
% cd(fileparts(which('acfDemoInria.m'))); 
dataDir='../../data/Inria/';

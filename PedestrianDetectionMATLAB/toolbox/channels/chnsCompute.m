...
p=pChns.pColor; 
nm='color channels';
I=rgbConvert(I,p.colorSpace); % No color convertion is made as I is already in the LUV-colorspace.
...
chns.info(end+1)=struct('name',name,'pChn',pChn,'nChns',size(data,3),'padWith',padWith);
end
